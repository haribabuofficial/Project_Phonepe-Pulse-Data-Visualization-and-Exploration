...
def top_chart_transaction_amount(table_name):
    ...
    with col1:
        fig_amount_1 = px.bar(df_1, x = 'States', y = 'Transaction_amount', title= 'TOP 10 OF TRANSACTION AMOUNT', color_discrete_sequence = px.colors.sequential.Aggrnyl, height= 650, width= 600, hover_name= 'States')
    ...
    with col2:
        fig_amount_2 = px.bar(df_2, x = 'States', y = 'Transaction_amount', title= 'LAST 10 OF TRANSACTION AMOUNT', color_discrete_sequence = px.colors.sequential.Aggrnyl_r, height= 650, width= 600, hover_name= 'States')
    ...
    fig_amount_3 = px.bar(df_3, y = 'States', x = 'Transaction_amount', title= 'AVERAGE OF TRANSACTION AMOUNT', color_discrete_sequence = px.colors.sequential.Bluered_r, height= 800, width= 1000,hover_name= 'States', orientation= 'h')
...
def top_chart_transaction_count(table_name):
    ...
    with col1:
        fig_amount_1 = px.bar(df_1, x = 'States', y = 'Transaction_count', title= 'TOP 10 OF TRANSACTION COUNT', color_discrete_sequence = px.colors.sequential.Aggrnyl, height= 650, width= 600, hover_name= 'States')
    ...
    with col2:
        ...
        fig_amount_2 = px.bar(df_2, x = 'States', y = 'Transaction_count', title= 'LAST 10 OFTRANSACTION COUNT', color_discrete_sequence = px.colors.sequential.Aggrnyl_r, height= 650, width= 600, hover_name= 'States')
    ...
    fig_amount_3 = px.bar(df_3, y = 'States', x = 'Transaction_count', title= 'AVERAGE OF TRANSACTION COUNT', color_discrete_sequence = px.colors.sequential.Bluered_r, height= 800, width= 1000, hover_name= 'States', orientation= 'h')
...
if select == "HOME":
    ...
    with col2:
        st.image(r"F:\hari babu\GUVI\Assignments\Phonepe\phonepe_image.png", width = 600)
    
    col3, col4 = st.columns(2)
    
    with col3:
        st.image(r"F:\hari babu\GUVI\Assignments\Phonepe\phonepe_image_3.png", width = 600)
    ...
    with col6:
        st.image(r"F:\hari babu\GUVI\Assignments\Phonepe\phonepe_image_2.png", width = 600)
